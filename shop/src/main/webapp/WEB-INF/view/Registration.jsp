        		...
        		<div class="panel-heading">
			    		...
			    		<form role="signup">
			                ...
			                <input type="text" name="name"  class="form-control input-sm" placeholder="Name">
			    				...
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="userId"  class="form-control input-sm" placeholder="UserId">
			    					</div>
			    				</div>
			    			</div>
			    			...
			    			<div class="row">
			    				...
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="contact"  class="form-control input-sm" placeholder="Contact">
			    					</div>
			    				</div>
			    			</div>
